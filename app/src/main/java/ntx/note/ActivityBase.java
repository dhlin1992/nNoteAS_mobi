...
/**
 * Base class for all nNote activities
 * 
...
//		backupHandler.removeCallbacks(backupAtExit);
	...
	private final static int backupDelay = 10 * 1000;
...
// Jacky 20170821 remove .backup()
//    private static Runnable backupAtExit = new Runnable() {
//    	public void run() {
//    		Bookshelf.getInstance().backup();
//    	}
//    };
...
//    		} else {
//    			if(NoteWriterActivity.getNoteEdited())
//    			{
//    			NoteWriterActivity.setNoteEdited(false);
//    			Bookshelf.getInstance().getTempCurrentBook().save();
