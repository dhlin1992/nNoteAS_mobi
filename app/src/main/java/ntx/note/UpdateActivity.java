...
public class UpdateActivity 
	...
	private final File defaultPath = new File(Environment.getExternalStorageDirectory(), Global.NOTE_DIR); 
		...
		new Thread(new Runnable(){
			public void run(){
				try {
					...
					storage.destroy();
					Intent intent = new Intent(getApplicationContext(), NoteWriterActivity.class);
