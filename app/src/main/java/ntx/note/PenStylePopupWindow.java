...
public class PenStylePopupWindow extends RelativePopupWindow {
    ...
    private ImageButton mBtnColorCharcoal;
    ...
    private void initView(View v) {
        ...
        mBtnColorCharcoal = (ImageButton) v.findViewById(R.id.btn_pen_color_charcoal);
        ...
        mBtnColorCharcoal.setOnClickListener(onBtnClickListener);
...
//                    nDrawHelper.NDrawSetPaintColor(Color.WHITE);
                    break;
                case R.id.btn_pen_color_charcoal:
                    penColor = ToolboxConfiguration.PenColor.CHARCOAL;
                    break;
                /**
                 * thickness
                 */
    ...
    private void setPenColorValue(int color) {
        ...
        mBtnColorCharcoal.setSelected(false);
        ...
        switch (color) {
            ...
            case ToolboxConfiguration.PenColor.WHITE:
                ...
                break;
            case ToolboxConfiguration.PenColor.CHARCOAL:
                mBtnColorCharcoal.setSelected(true);
                break;
        }
