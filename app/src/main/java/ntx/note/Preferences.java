...
public class Preferences 
	...
	protected static final String KEY_BACKUP_DIR = StorageAndroid.KEY_BACKUP_DIR;
	...
	protected static final String KEY_TOOLBOX_IS_ON_LEFT = "toolbox_left";
	protected static final String KEY_PEN_TYPE = "pen_type";
	protected static final String KEY_PEN_COLOR = "pen_color";
	protected static final String KEY_PEN_THICKNESS = "pen_thickness";
	protected static final String KEY_TOOLBAR_EXPAND = "toolbar_expand";
	protected static final String KEY_PAGE_TITLE_SHOW_MEMO = "page_title_show_memo";

	protected static final String KEY_PAPER_BACKGROUND_USER_DEFINED_1 = "paper_background_user_defined_1";
	protected static final String KEY_PAPER_BACKGROUND_USER_DEFINED_2 = "paper_background_user_defined_2";
	protected static final String KEY_PAPER_BACKGROUND_USER_DEFINED_3 = "paper_background_user_defined_3";
	protected static final String KEY_PAPER_BACKGROUND_USER_DEFINED_4 = "paper_background_user_defined_4";

	protected static final String KEY_TEXT_BOX_FONT_SIZE = "text_box_font_size";
	protected static final String KEY_TEXT_BOX_COLOR = "text_box_color";
	protected static final String KEY_TEXT_BOX_IS_BOLD = "text_box_is_bold";
	protected static final String KEY_TEXT_BOX_IS_ITALIC = "text_box_is_italic";
	protected static final String KEY_TEXT_BOX_IS_UNDER_LINE = "text_box_is_under_line";
