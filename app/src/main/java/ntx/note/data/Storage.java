...
public abstract class Storage {
    ...
    protected void postInitializaton() {
         ...
         * The Storage initializer do not call the method
         * The bookshelf initialization should be called by programmer designed flow.
         */
    ...
    /**
     * Get the directory containing the data files. Usually /data/data/ntx.note/files
     *
     * @return a directory
     */
...
//		return new File(getExternalStorageDirectory(), Global.NOTE_DIR);
        return new File(Global.PACKAGE_DATA_DIR + Global.FILE_TEMP_DIR); // dataDir=/data/data/ntx.note2
    }
    ...
    abstract public void saveCurrentBookUUID(UUID uuid);
