...
public class TagManager {
    ...
    public static final String QUICK_TAG_NAME = "*";
    ...
    public TagSet newTagSet() {
        ...
        Tag quickTag = newTag(QUICK_TAG_NAME);
        ts.add(quickTag);
    ...
    public LinkedList<Tag> findTagContain(String name) {
        LinkedList<Tag> result = new LinkedList<>();
        for (Tag t : allTags) {
            String tNameLowerCase = t.name.toLowerCase();
            if (tNameLowerCase.contains(name.toLowerCase())) {
                result.add(t);
            }
        }
        return result;
