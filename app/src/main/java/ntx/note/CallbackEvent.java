...
public class CallbackEvent {
    ...
    public final static String BACKUP_NOTE_PROGRESS_START = "backup_note_progress_start";
    ...
    public final static String MORE_BACKUP = "more_backup";
    ...
    public final static String RESET_BACKUP_TIME = "reset__backup_time";
    ...
    public final static String TEXT_BOX_SELECTED = "text_box_selected";
    public final static String TEXT_BOX_UNSELECTED = "text_box_unselected";
    public final static String TEXT_BOX_DELETE = "text_box_delete";
    public final static String DELETE_NOTEBOOK = "delete notebook";
