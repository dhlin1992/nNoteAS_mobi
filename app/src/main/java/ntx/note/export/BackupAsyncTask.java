...
import static ntx.note.CallbackEvent.BACKUP_NOTE_PROGRESS_START;
...
public class BackupAsyncTask extends AsyncTask<String, Integer, Integer> {
    ...
    protected void onPreExecute() {
        ...
        CallbackEvent startBackupEvent = new CallbackEvent();
        startBackupEvent.setMessage(BACKUP_NOTE_PROGRESS_START);
        EventBus.getDefault().post(startBackupEvent);
