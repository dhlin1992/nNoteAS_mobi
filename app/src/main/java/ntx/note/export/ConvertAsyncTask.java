...
public class ConvertAsyncTask extends AsyncTask<String, Integer, Integer> {
    ...
    protected Integer doInBackground(String... arg0) {
        ...
        Book book;
        if (mBookUuid.equals(Global.getCurrentBook().getUUID())) {
            book = Global.getCurrentBook();
            book.saveNoWaitInitialization();
        } else
            book = new Book(mBookUuid, true);

        mConvertingDialogFragment.setBarMaxValue(book.pagesSize());
        ...
        if (ConvertType.PNG == mConvertType) {
            ...
            artist.setBackgroundVisible(false);
