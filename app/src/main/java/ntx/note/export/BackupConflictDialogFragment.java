...
public class BackupConflictDialogFragment extends CustomDialogFragment {
    ...
    private static String ARGUMENT_KEY_IS_BACKUP_ALL = "is_backup_all";
    ...
    public static BackupConflictDialogFragment newInstance(int backupStorage, ArrayList<UUID> backupUuidList, ArrayList<UUID> backupConflictUuidList, boolean deleteAfterBackup, boolean isBackupAll) {
        ...
        bundle.putBoolean(ARGUMENT_KEY_IS_BACKUP_ALL, isBackupAll);
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        mIsBackupAll = getArguments().getBoolean(ARGUMENT_KEY_IS_BACKUP_ALL);
            ...
            switch (view.getId()) {
                ...
                case R.id.btn_conflict_ok:
                    ...
                    if (mIsBackupAll) {
                        ...
                        callbackEvent.setMessage(CallbackEvent.RESET_BACKUP_TIME);
