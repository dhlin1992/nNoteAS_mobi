...
public class RenameNoteDialogFragment extends CustomDialogFragment implements OnClickListener {
    ...
    private void initView(View v) {
        ...
        text.requestFocus();
        showInputMethod();
        text.setNextFocusLeftId(text.getId());
        text.setNextFocusRightId(text.getId());
        text.setNextFocusUpId(text.getId());
        text.setNextFocusDownId(text.getId());
        text.setNextFocusForwardId(text.getId());
    ...
    private class SaveTitleAsyncTask extends AsyncTask<String, Void, Void> {
        ...
        protected Void doInBackground(String... strings) {
            ...
            if (mBook.getUUID().equals(Global.getCurrentBook().getUUID())) {
                bookObject_forSave = Global.getCurrentBook();
            } else {
