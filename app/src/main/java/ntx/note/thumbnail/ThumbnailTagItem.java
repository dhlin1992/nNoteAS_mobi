...
public class ThumbnailTagItem extends LinearLayout {
    ...
    public void setTagCheck(boolean isCheck, boolean callChangeListener) {
        if (isCheck)
            mBtnTagCheck.setChecked(callChangeListener);
        else
            mBtnTagCheck.setUnchecked(callChangeListener);
    }
