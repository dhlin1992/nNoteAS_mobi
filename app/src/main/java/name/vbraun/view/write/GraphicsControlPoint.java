...
public abstract class GraphicsControlPoint extends Graphics {
    ...
    protected LinkedList<ControlPoint> backupControlPoints = new LinkedList<ControlPoint>();
...
//			canvas.drawCircle(x, y, controlPointRadius(), outlinePaint);
    ...
    protected BitmapShader getShaderByPenColorSpecialEffect(int pen_color) {
