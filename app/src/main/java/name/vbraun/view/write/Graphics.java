...
public abstract class Graphics {
    ...
    abstract public void drawThumbnail(Canvas c);
    ...
    abstract public boolean isCenterControlPoint(GraphicsControlPoint.ControlPoint controlPoint);

    abstract public Rect getOutLineBounding();

    abstract public int getBoundingGap();
}
