 ...
 *
 */
public class TouchHandlerActivePen extends TouchHandlerPenABC {
	...
	protected boolean onTouchEvent(MotionEvent event) {
		...
		if (action == MotionEvent.ACTION_MOVE) {
			...
			// Daniel 20181121 : Fix pencil stroke with thickness 1 or 2 will have ghosting when erase,
			// Since nDraw enable, drawOutline can be ignored.
