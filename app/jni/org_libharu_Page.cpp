...
JNIEXPORT void JNICALL Java_org_libharu_Page_circle
  (JNIEnv *env, jobject obj, jfloat x, jfloat y, jfloat r)
{
  haru_setup_error_handler(env, __func__);
  HPDF_Page page = get_HPDF_Page(env, obj);
...
JNIEXPORT void JNICALL Java_org_libharu_Page_ellipse
  (JNIEnv *env, jobject obj, jfloat x, jfloat y, jfloat xr, jfloat yr)
{
  haru_setup_error_handler(env, __func__);
  HPDF_Page page = get_HPDF_Page(env, obj);
  HPDF_Page_Ellipse(page, x, y, xr, yr);
  haru_clear_error_handler();
}
